...
export declare class SwitchToUserWorker extends BaseOpenAiWorker {
    ...
    doDispatch(actions: OpenAiChatActions, _data: ChatCommandData, _state: ChatState<OpenAiAssistantConfig, ChatData>, control: DispatchControl<OpenAiChatActions, OpenAiAssistantConfig, ChatData>): Promise<void>;
}

...
exports.BaseOpenAiWorkerCommand = void 0;
const firebase_ai_chat_core_1 = require("@motorro/firebase-ai-chat-core");
class BaseOpenAiWorkerCommand extends firebase_ai_chat_core_1.BaseChatWorker {
    /**
     * Constructor
    ...
    async doDispatch(actions, data, state, control) {
        await this.execute(data, state, control);
...
exports.BaseOpenAiWorkerCommand = BaseOpenAiWorkerCommand;
